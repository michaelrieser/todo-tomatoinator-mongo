console.log('jquery-countdown loaded!');
    ...
    startTimer: function(user_settings) {
      ...
      return this.each(function() {
        ...
        var interval = setInterval(function() {
          // NOTE: when pause button is hit, timer $(this).data('countdown.state') set to 'paused' causing else block below to clearInterval
